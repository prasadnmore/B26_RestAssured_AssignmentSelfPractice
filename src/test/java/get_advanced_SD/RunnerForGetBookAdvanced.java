...
@SelectClasspathResource("get_advanced_FF")
@ConfigurationParameter(key = Constants.FEATURES_PROPERTY_NAME,value = "src/test/resources/get_advanced_FF/GetBooksTestingAdvanced.feature" )
@ConfigurationParameter(key = Constants.GLUE_PROPERTY_NAME,value = "get_advanced_SD")
...
public class RunnerForGetBookAdvanced {
